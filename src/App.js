          ...
          <div className="p-3 bg-white border border-gray-200 rounded-lg shadow-sm">
            {currentData.fields.map((field, index) => {
              if (field.type === 'textfield') {
                ...
                return (
                  <div className="mb-5" key={index}>
                    <label htmlFor={field.label} className="block mb-2 text-sm font-medium text-gray-900 text-start" >
                      {field.label}
                    </label>
                    <textarea
                      id={field.label.toLowerCase()}
                ...
                return (
                  <div className="mb-5" key={index}>
                    ...
                    <select id={field.label.toLowerCase()} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 block w-full p-2.5" required={field.required} >
